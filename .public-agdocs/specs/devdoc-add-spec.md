Update docs/dev-docs/dev-summary-v2.md with contents for Spec only under v0.2.3.

Add the contents from .public-agdocs/specs/<spec-name> where spec-name is listed under the "Spec" bullet.

Wrap the spec file content in the devdoc with a pre tag.
...
Should use the spec file `extra-args-test.md` and should grab the contents from .public-agdocs/specs/extra-args-test.md which will produce this:
