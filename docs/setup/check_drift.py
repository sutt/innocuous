...
# run as: uv run docs/setup/check_drift.py
# or: INNOCUOUS_LLM_PATH=/path/to/model.gguf uv run docs/setup/check_drift.py
...
# Check for match
EXPECTED_SHA = "69a1a31fb9af2b67f7953b3614e6e04fa8147033a3029bdcb8d004dbaf713f25"

try:
    assert hash_full_logits == EXPECTED_SHA
    print("Sha of logits matches! Your llama.cpp is configured properly.")
except:
    print("Sha of logits does NOT match. Your llama.cpp is NOT configured properly.")
    print(f"Expected: {EXPECTED_SHA}")
    print(f"Actual:   {hash_full_logits}")
